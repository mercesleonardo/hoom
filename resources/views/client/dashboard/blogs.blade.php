        ...
        <div class="conteudo-blogs">
            ...
            <div class="conteudo-box-blogs">
                @if ($blogs->count())
                                ...
                                <div class="descricao-blogs">
                                    ...
                                    <div class="pessoa-blogs">
                                        <div class="perfil-blogs">
                                            <img class="img-pessoa-blogs"
                                                src="{{ asset('storage/' . $itens->path_image_author) }}" alt="">
                                            <div class="descricao-pessoa-blogs">
                                                <h4 class="titulo-pessoa-blogs">{{ $itens->author }}</h4>
                                                <span
                                                    class="minutos-blogs">{{ Carbon\Carbon::parse($itens->created_at)->format('d/m/Y') }}</span>
                                            </div>
                                        </div>
                    ...
                    @endforeach
                @else
                    <p class="blogs-msg">Ainda não existem blogs cadastrados. Aguarde...</p>
                @endif
            </div>
