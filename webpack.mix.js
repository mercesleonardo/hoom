...
mix
    ...
    .scripts('resources/Admin/assets/js/app.min.js', 'public/admin/assets/js/app.min.js')
    .scripts('resources/Admin/assets/js/vendor.min.js', 'public/admin/assets/js/vendor.min.js')
    .scripts('resources/Admin/assets/js/custom.js', 'public/admin/assets/js/custom.js')
    // plugins
    ...
    .scripts('resources/Admin/assets/js/libs/ckeditor.js', 'public/admin/assets/libs/ckeditor.js')
    ...
    .scripts('resources/Admin/assets/js/libs/jquery.sortable.min.js', 'public/admin/assets/libs/jquery.sortable.min.js')
    ...
    // Pages
    .scripts('resources/Admin/assets/js/pages/form-validation.init.js', 'public/admin/assets/js/pages/form-validation.init.js')
    .scripts('resources/Admin/assets/js/pages/form-advanced.init.js', 'public/admin/assets/js/pages/form-advanced.init.js')
    .scripts('resources/Admin/assets/js/pages/form-pickers.init.js', 'public/admin/assets/js/pages/form-pickers.init.js')
    .scripts('resources/Admin/assets/js/pages/form-masks.init.js', 'public/admin/assets/js/pages/form-masks.init.js')
    .scripts('resources/Admin/assets/js/pages/form-fileuploads.init.js', 'public/admin/assets/js/pages/form-fileuploads.init.js')
    .scripts('resources/Admin/assets/js/pages/add-product.init.js', 'public/admin/assets/js/pages/add-product.init.js')
    .scripts('resources/Admin/assets/js/pages/ckeditor.init.js', 'public/admin/assets/js/pages/ckeditor.init.js')
    .scripts('resources/Admin/assets/js/pages/bootstrap-tables.init.js', 'public/admin/assets/js/pages/bootstrap-tables.init.js')
    .scripts('resources/Admin/assets/js/pages/tabledit.init.js', 'public/admin/assets/js/pages/tabledit.init.js')
    .scripts('resources/Admin/assets/js/pages/toastr.init.js', 'public/admin/assets/js/pages/toastr.init.js')
    .scripts('resources/Admin/assets/js/pages/materialdesign.init.js', 'public/admin/assets/js/pages/materialdesign.init.js')
    .scripts('resources/Admin/assets/js/pages/form-imagecrop.init.js', 'public/admin/assets/js/pages/form-imagecrop.init.js')

    //CSS
    .styles('resources/Admin/assets/css/config/bootstrap.min.css', 'public/admin/assets/css/config/bootstrap.min.css')
    .styles('resources/Admin/assets/css/config/app.min.css', 'public/admin/assets/css/config/app.min.css')
    .styles('resources/Admin/assets/css/config/bootstrap-dark.min.css', 'public/admin/assets/css/config/bootstrap-dark.min.css')
    .styles('resources/Admin/assets/css/config/app-dark.min.css', 'public/admin/assets/css/config/app-dark.min.css')
    .styles('resources/Admin/assets/css/icons.min.css', 'public/admin/assets/css/icons.min.css')
    .styles('resources/Admin/assets/css/custom.css', 'public/admin/assets/css/custom.css')
